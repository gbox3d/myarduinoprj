...
0~1 : result 00 success, 01 error
2~5 : value
...
void request_Server(WiFiClient *client,String &strReq) {
...
//read setup infomation form EEPROM 
  {
    ...
    // start the Ethernet connection:
      ...
      */
      ...
      char ssid[] = "goorume"; //  your network SSID (name) 
      char pass[] = "808671004";    // your network password (use for WPA, or use as key for WEP)
